  ...
  const skillRows = [
    {
      ...
      skills: [
        { name: "HTML", icon: <FileCode className="w-5 h-5 md:w-6 md:h-6" /> },
        { name: "CSS", icon: <Palette className="w-5 h-5 md:w-6 md:h-6" /> },
        { name: "JavaScript", icon: <Code2 className="w-5 h-5 md:w-6 md:h-6" />, highlight: true },
        { name: "Bootstrap", icon: <Layout className="w-5 h-5 md:w-6 md:h-6" /> },
        { name: "Tailwind", icon: <Layout className="w-5 h-5 md:w-6 md:h-6" /> }
      ]
    },
    {
      id: "row-2",
      ...
      skills: [
        { name: "React", icon: <Smartphone className="w-5 h-5 md:w-6 md:h-6" />, highlight: true },
        { name: "Express.js", icon: <Server className="w-5 h-5 md:w-6 md:h-6" /> },
        { name: "MongoDB", icon: <Database className="w-5 h-5 md:w-6 md:h-6" /> },
        { name: "Node.js", icon: <Terminal className="w-5 h-5 md:w-6 md:h-6" /> }
      ]
    },
    {
      id: "row-3",
      ...
      skills: [
        { name: "Angular", icon: <ShieldCheck className="w-5 h-5 md:w-6 md:h-6" /> },
        { name: "GSAP", icon: <MotionIcon className="w-5 h-5 md:w-6 md:h-6" /> },
        { name: "Framer Motion", icon: <Layers className="w-5 h-5 md:w-6 md:h-6" /> }
      ]
    },
    {
      id: "row-4",
      ...
      skills: [
        { name: "TypeScript", icon: <ShieldCheck className="w-5 h-5 md:w-6 md:h-6" />, highlight: true },
        { name: "Git & GitHub", icon: <Github className="w-5 h-5 md:w-6 md:h-6" /> }
      ]
    }
  ];
